...
<template>
	<div class="category">
		...
		<!-- 栏目管理表格结束 -->
		<!-- 模态框 -->
		<el-dialog :title="cDialog.title" :visible.sync="cDialog.visible" @open='open'>
			{{cDialog.form}}
		  <el-form  :rules='rules' ref='cDialog.form' :model="cDialog.form" size="mini" label-position="left" >
	...
	export default {
		...
		methods:{
			...
			toUpdateCategory(row){
				...
				// this.cDialog.form=JSON.parse(JSON.stringify(row));
